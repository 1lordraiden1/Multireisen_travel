...
class _DisplayImagesScreenState extends State<DisplayImagesScreen> {
  ...
  Widget build(BuildContext context) {
    List<String> images = widget.img.isEmpty
        ? [
            'https://media.istockphoto.com/id/1222623844/photo/master-bedroom-in-new-luxury-home-with-chandelier-and-large-bank-of-windows-with-view-of-trees.jpg?s=2048x2048&w=is&k=20&c=7ihMopQdAob0ZEz5HIztHruElRrktcfJJ_VI1KN-nlg=',
      ...
      body: Stack(
        children: [
          ...
          Align(
            ...
            child: ImageIndicatorRotationView(
              imagePath: index == 0
                  ? ImageAssets.firstSpecsImg
                  : ImageAssets.secondSpecsImg,
            ),
          )
        ],
      ),
