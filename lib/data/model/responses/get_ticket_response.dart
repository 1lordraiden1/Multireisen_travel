...
GetTicketResponse getTicketResponseFromJson(String str) =>
    GetTicketResponse.fromJson(json.decode(str));

String getTicketResponseToJson(GetTicketResponse data) =>
