...
SavePassengersResponse savePassengersResponseFromJson(String str) => SavePassengersResponse.fromJson(json.decode(str));

String savePassengersResponseToJson(SavePassengersResponse data) => json.encode(data.toJson());
...
class SavePassengersResponse {
    ...
    factory SavePassengersResponse.fromJson(Map<String, dynamic> json) => _$SavePassengersResponseFromJson(json);
