...
FinalizeBookingResponse finalizeBookingResponseFromJson(String str) =>
    FinalizeBookingResponse.fromJson(json.decode(str));

String finalizeBookingResponseToJson(FinalizeBookingResponse data) =>
...
class FinalizeBookingResponse {
  ...
  factory FinalizeBookingResponse.fromJson(Map<String, dynamic> json) =>
      _$FinalizeBookingResponseFromJson(json);
