...
class HomeServices {
  ...
  Future<List<Map<String, dynamic>>> fetchCountriesData() async {
    final url = Uri.parse(
      EndPoints.oldUrl + EndPoints.getCountries,
  ...
  Future<List<Map<String, dynamic>>> fetchCitiesData(String value) async {
    final url = Uri.parse(
      EndPoints.oldUrl + EndPoints.getCities + value,
    ); // Replace with your API endpoint
    print(url);
    try {
      //final String guest = await AuthService().getOurAuth();
...
/*   Future<List<Airport>> getAirports(String searchValue) async {
  ...
  Future<List<Map<String, dynamic>>> fetchAirportsData(
    ...
    final url = Uri.parse(
      EndPoints.oldUrl + EndPoints.getAirports + searchValue,
    ); // Replace with your API endpoint
  ...
  /* Future<List<Map<String, dynamic>>> */ searchForFlights(
    ...
    final url = Uri.parse(EndPoints.oldUrl + EndPoints.searchAirports);
    print(url);
 ...
 */
  ...
  searchForFlightDetails(
    ...
    final url = Uri.parse(EndPoints.oldUrl + EndPoints.searchDetails);
    print(url);
  ...
  gettingTicketWhenLCCisTrue(
    ...
    final url = Uri.parse(EndPoints.oldUrl + EndPoints.getTicketLCCTrue);
    print(url);
  ...
  gettingBookingWhenLCCisFalse(
    ...
    final url = Uri.parse(EndPoints.oldUrl + EndPoints.bookingLCCFalse);
    print(url);
  ...
  gettingTicketWhenLCCisFalse(
    ...
    final url = Uri.parse(EndPoints.oldUrl + EndPoints.ticketLCCFalse);
    print(url);
